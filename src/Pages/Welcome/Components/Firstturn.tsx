...
const Firstturn : React.FC = () => {
  return (
    <div className='absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 flex justify-center items-center w-10/12 min-h-40 bg-sky-50 p-4 rounded-xl'>
      <div>
