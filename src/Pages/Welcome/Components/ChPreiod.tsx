...
<div>
        ...
        <p className='relative top-5 text-center text-amber-700 text-sm p-4  '>رَسولَ اللهِ صلَّى اللهُ عليه وسلَّم سُئِلَ: أيُّ العَمَلِ أحَبُّ إلى اللهِ؟ قال: أدومُه وإن قَلَّ, مش مهم توصل بسرعة المهم توصل!</p>
