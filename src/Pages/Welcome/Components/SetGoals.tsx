  ...
  {Goals.map((Goal,i) => (
    <button key={i} className={`p-2 text-2xl  ${SelectedGoal.includes(Goal) ? 'bg-indigo-500 text-white' : 'border-2 border-indigo-500 text-indigo-600'} rounded-xl`} onClick={handleSelect}>{Goal}</button>
  ))}   
</div>
